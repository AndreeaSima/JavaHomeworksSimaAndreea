/*
 * Implements the HelloWorldAnonymousClasses class without using any 
   anonymous classes
 */
package Tema5;
...
public class HelloWorldWithoutAnonymousClasses {
    ...
    public void sayHello() {
        ...
        /* The englishGreeting, frenchGreeting and spanishGreeting variables 
           are instances of the EnglishGreeting, FrenchGreeting and
           SpanishGreeting classes. 
           As their type is HelloWorld they can only access 
           methods overriden from the HelloWorld interface.
        */
